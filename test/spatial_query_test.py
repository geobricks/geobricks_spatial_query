...
class GeobricksTest(unittest.TestCase):
    ...
    def test_gaul0_3857_in_4326(self):
        ...
        self.assertEqual(result, [[60.478443145752, 38.4834261112114], [74.8794311871666, 29.3774768667367]])

    def test_gaul0_3857_in_3857(self):
        sq = SpatialQuery(config)
        result = sq.query_bbox(self.db, self.layer_table, self.column_code, self.codes, "3857")
        print result
        self.assertEqual(result, [[6732429.49495505, 4647944.61027722], [8335540.15064535, 3423778.67185]])


    def test_gaul0_3857_in_4326_geojson(self):
            sq = SpatialQuery(config)
    ...
    def test_gaul0_3857_in_3857_geojson(self):
        sq = SpatialQuery(config)
